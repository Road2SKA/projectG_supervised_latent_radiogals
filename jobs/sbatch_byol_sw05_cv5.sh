#!/bin/bash
#SBATCH --job-name=byol_sw05_cv5
#SBATCH --output=outputs/logs/byol_sw05_cv5_%j.out
#SBATCH --error=outputs/logs/byol_sw05_cv5_%j.err
#SBATCH --gres=gpu:1
#SBATCH --mem=32G
...
RUN_NAME="pd128_qext_v1_wd1e-3_lrconst_sw0.5_f1"
